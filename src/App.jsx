...
export const LISTS = {
  Locations: [
    ...
    { text: "Rainforest" }, { text: "Crowded market" }, { text: "Ancient temple" }, { text: "Tube station" },
    { text: "Desert oasis" }, { text: "Haunted manor" }, { text: "Secluded cabin" }, { text: "Pirate ship" },
    { text: "Castle dungeon" }, { text: "Railway station" }, { text: "Sunny beach" }, { text: "Volcano crater" },
    { text: "Secret laboratory" }, { text: "Treehouse" }, { text: "Skyscraper rooftop" }, { text: "Foggy forest" },
    { text: "Village café" }, { text: "Boarding school" }, { text: "Ice hotel" }, { text: "Theme park" },
    ...
    { text: "Riverside dock" }, { text: "Police station" }, { text: "Cosy bookshop" }, { text: "Mountain cabin" },
    { text: "School gym" }, { text: "Science classroom" }, { text: "Fire station" }, { text: "Aquarium" },
    { text: "Opera house" }, { text: "Sports stadium" }, { text: "Petting zoo" }, { text: "Theme park ride" },
    { text: "Coffee shop" }, { text: "Art gallery" }, { text: "Clock tower" }, { text: "Creepy funfair" },
    { text: "Old-fashioned train" }, { text: "TV studio" }, { text: "Music festival" }, { text: "Ice rink" },
    { text: "Farmland barn" }, { text: "Bank vault" }, { text: "Suburban back garden" }, { text: "Zoo" },
    { text: "Medieval castle" }, { text: "Roller skating rink" }, { text: "Tropical island" }, { text: "Desert motorway" },
    { text: "Antique shop" }, { text: "Sunflower field" }, { text: "Campsite" }, { text: "Lighthouse" },
    { text: "Cemetery" }, { text: "Comic book shop" }, { text: "Bakery" }, { text: "Bowling alley" },
    ...
    { text: "Sweet shop" }, { text: "Futuristic city" }, { text: "Construction site" }, { text: "Wedding chapel" },
    { text: "Science fair" }, { text: "Confectionery factory" }, { text: "Hospital A&E" }, { text: "Ice cream parlour" },
    { text: "City bus" }, { text: "Prison cell" }, { text: "Rooftop pool" }, { text: "Cattle farm" },
    { text: "Community centre" }, { text: "Arcade" }, { text: "Horse stable" }, { text: "Theatre stage" },
    ...
    { text: "Beach promenade" }, { text: "Mountain pass" }, { text: "Aeroplane hangar" }, { text: "Underground" },
    { text: "Planet surface" }, { text: "Coach station" }, { text: "Abandoned funfair" }, { text: "Clifftop cave" },
    { text: "Industrial factory" }, { text: "Iceberg" }, { text: "Quaint village square" }, { text: "Harbour" },
    { text: "Shipyard" }, { text: "Railway tunnel" }, { text: "Penthouse suite" }, { text: "Sunken ruin" },
    { text: "Rooftop greenhouse" }, { text: "Old mill" }, { text: "Alleyway" }, { text: "Bazaar" },
    ...
    { text: "Desolate tundra" }, { text: "Arctic research station" }, { text: "Flooded street" }, { text: "Misty swamp" },
    ...
    { text: "Jungle outpost" }, { text: "Ruined castle" }, { text: "Underground station" }, { text: "Town square" },
    { text: "Mountain meadow" }, { text: "Clifftop path" }, { text: "Coral reef" }, { text: "Hidden glen" },
    ...
    { text: "Sky bridge" }, { text: "Cave entrance" }, { text: "Old fort" }, { text: "City rooftop" },
    { text: "Urban plaza" }, { text: "Open meadow" }, { text: "Cypress swamp" }, { text: "Petrol station" },
    { text: "School playground" }, { text: "Forest path" }, { text: "Seaside dock" }, { text: "Wheat field" },
    { text: "Country lane" }, { text: "Town alley" }, { text: "Suburban street" }, { text: "Jungle trail" },
    ...
    { text: "Marshland" }, { text: "Stone quarry" }, { text: "Sculpture garden" }, { text: "Cable car" },
    { text: "Harbourmaster’s office" }, { text: "Library basement" }, { text: "Pirate cove" }, { text: "Magic portal" },
    ...
    { text: "Ferry terminal" }, { text: "Bridge underpass" }, { text: "Clifftop monastery" }, { text: "Military base" },
    ...
    { text: "Fruit stall" }, { text: "Aqueduct" }, { text: "Terraced rice field" }, { text: "Maze garden" },
    { text: "Power station" }, { text: "Mountain pass lodge" }, { text: "Open-air theatre" }, { text: "Moonlit clearing" },
    ...
    { text: "Market stall" }, { text: "Shipping dock" }, { text: "Canal lock" }, { text: "Medieval village" },
    ...
    { text: "Railway platform" }, { text: "Zoo aviary" }, { text: "Farmhouse kitchen" }, { text: "Sculpture hall" },
    { text: "Sunken courtyard" }, { text: "Cliff dwelling" }, { text: "Tunnel entrance" }, { text: "Ferris wheel" },
    { text: "Basement vault" }, { text: "Ship’s bridge" }, { text: "Lake pier" }, { text: "Floating island" },
    ...
    { text: "Vintage train carriage" }, { text: "Underground city" }, { text: "Tree nursery" }, { text: "Rubbish tip" },
    { text: "Mine shaft" }, { text: "Solar observatory" }, { text: "Water park" }, { text: "Cabin in the woods" },
    { text: "Volcanic vent" }, { text: "Storm shelter" }, { text: "Farm silo" }, { text: "School auditorium" },
    { text: "Casino" }, { text: "Festival ground" }, { text: "Big top" }, { text: "Train graveyard" },
    { text: "Grain elevator" }, { text: "Observation balloon" }, { text: "Fire station" }, { text: "Old city wall" },
    { text: "Wine cellar" }, { text: "Aquaponics farm" }, { text: "Wind farm" }, { text: "Jungle research lab" },
    { text: "Hilltop fort" }, { text: "Historic battlefield" }, { text: "Catacombs" }, { text: "Prison yard" },
    { text: "Motel car park" }, { text: "River barge" }, { text: "Old barn" }, { text: "Tube tunnel" },
    ...
    { text: "Hangar bay" }, { text: "Crater lake" }, { text: "Foggy graveyard" }, { text: "Bird sanctuary" },
    { text: "Playground" }, { text: "Cricket pitch" }, { text: "Abandoned airport" }, { text: "Dune field" },
  ...
  { text: "Baker" }, { text: "Police officer" }, { text: "Newsreader" }, // UK
  { text: "Musician" }, { text: "Farmer" }, { text: "Architect" }, { text: "Plumber" }, { text: "Carpenter" },
  { text: "Zookeeper" }, { text: "Waiter" }, { text: "Barista" }, { text: "Sculptor" }, { text: "Taxi driver" },
  { text: "Fashion designer" }, { text: "Journalist" }, { text: "Surgeon" }, { text: "Cashier" },
  { text: "Caretaker" }, // UK for Janitor
  { text: "Professional gamer" }, { text: "Electrician" }, { text: "Coach" }, { text: "Travel agent" },
  { text: "Flight attendant" }, { text: "Bus driver" }, { text: "Park ranger" }, { text: "Choreographer" },
  { text: "Film director" }, { text: "Tour guide" }, { text: "Actor" }, { text: "Tailor" }, { text: "Paramedic" },
  { text: "Engineer" }, { text: "Butcher" }, { text: "Wedding planner" }, { text: "Estate agent" }, // UK
  { text: "Blacksmith" }, { text: "Dentist" }, { text: "Psychologist" }, { text: "Pharmacist" },
  { text: "Biologist" }, { text: "Astronomer" }, { text: "Translator" }, { text: "Judge" },
  { text: "Marine biologist" }, { text: "Private investigator" }, { text: "Social worker" },
  { text: "Delivery driver" }, { text: "Dog walker" }, { text: "Tattoo artist" }, { text: "DJ" },
  { text: "Yoga instructor" }, { text: "Dog trainer" }, { text: "Game developer" }, { text: "Lifeguard" },
  { text: "Stunt double" }, { text: "Comic artist" }, { text: "Ice cream vendor" }, { text: "Forensic analyst" },
  { text: "Nutritionist" }, { text: "Therapist" }, { text: "Book editor" }, { text: "Podcaster" },
  { text: "Meteorologist" }, { text: "Florist" }, { text: "Shopping centre security guard" }, // UK for Mall
  { text: "Locksmith" }, { text: "Antique dealer" }, { text: "Bouncer" }, { text: "Pizza delivery person" },
  { text: "Makeup artist" }, { text: "Chocolatier" }, { text: "Auctioneer" }, { text: "Wildlife photographer" },
  { text: "Stagehand" }, { text: "Radio host" }, { text: "Dog groomer" }, { text: "Toy designer" },
  { text: "Optician" }, { text: "Balloon artist" }, { text: "Pastry chef" }, { text: "Acrobat" },
  { text: "Ballet dancer" }, { text: "Calligrapher" }, { text: "Sound engineer" }, { text: "Winemaker" }, // UK: no space
  { text: "Furniture maker" }, { text: "Cobbler" }, { text: "Court reporter" }, { text: "Tattoo designer" },
  { text: "Horticulturist" }, { text: "Film critic" }, { text: "Barber" }, { text: "Sous chef" },
  { text: "Composer" }, { text: "Data analyst" }, { text: "Drone operator" }, { text: "Ethicist" },
  { text: "Game tester" }, { text: "Hotel manager" }, { text: "Interpreter" }, { text: "Jeweller" },
  { text: "Lab technician" }, { text: "Lighting designer" }, { text: "Museum curator" }, { text: "Naval officer" },
  { text: "Oceanographer" }, { text: "Palaeontologist" }, // UK spelling
  { text: "Parkour instructor" }, { text: "Perfumer" }, { text: "Pet sitter" }, { text: "Phlebotomist" },
  { text: "Puppeteer" }, { text: "Quilter" }, { text: "Robotics engineer" }, { text: "Set designer" },
  { text: "Ship captain" }, { text: "Sign language interpreter" }, { text: "Sommelier" }, { text: "Statistician" },
  { text: "Street artist" }, { text: "Toy inventor" }, { text: "Travel blogger" }, { text: "Urban planner" },
  { text: "Valet" }, { text: "Voice actor" }, { text: "Web developer" }, { text: "Zoologist" },
  { text: "Ice sculptor" }, { text: "Sports coach" }, { text: "Bookbinder" }, { text: "Fire eater" },
  { text: "Graffiti artist" }, { text: "Hypnotist" }, { text: "Illusionist" }, { text: "Juggler" },
  { text: "Karate instructor" }, { text: "Makeup consultant" }, { text: "News producer" }, { text: "Opera singer" },
  { text: "Puppy raiser" }, { text: "Quizmaster" }, { text: "Referee" }, { text: "Sand sculptor" },
  { text: "Swordsmith" }, { text: "Taxi driver" }, // UK: Uber driver could also stay
  { text: "Vlogger" }, { text: "Wildlife rehabilitator" }, { text: "X-ray technician" },
  { text: "Yacht captain" }, { text: "Perfume tester" }, { text: "Costume designer" },
  { text: "Fireworks technician" }, { text: "Wedding photographer" }, { text: "Freelance writer" },
  ...
  { text: "Ornithologist" }, { text: "Herpetologist" }, { text: "Gemologist" }, // "Gemologist" is US, UK is "Gemologist" but can use "Gemmologist" for strict UK
  { text: "Cultural anthropologist" }, { text: "Documentary filmmaker" }, { text: "Court clerk" }, { text: "Sports statistician" },
  { text: "Prosthetist" }, { text: "Cytotechnologist" }, { text: "CNC machinist" }, { text: "Puppy socialiser" }, // UK spelling
  { text: "Social media manager" }, { text: "Podcast editor" }, { text: "Stained glass artist" }, { text: "Lighting technician" },
  { text: "Vineyard manager" }, { text: "Tattoo model" }, { text: "Foley artist" }, { text: "Stage manager" },
  { text: "Concert promoter" }, { text: "Animal behaviourist" }, // UK spelling
  { text: "Theme park designer" }, { text: "Children's party entertainer" }, { text: "Park naturalist" },
  { text: "Livestream host" }, { text: "Reenactor" }, { text: "Auction house staff" }, { text: "Brand ambassador" },
  { text: "Voiceover director" }, { text: "Event MC" }, { text: "Haunted house actor" }, { text: "Reptile handler" },
  { text: "Cider maker" }, { text: "Holiday decorator" }, { text: "Waste management specialist" }, { text: "Aquarium diver" },
  { text: "Tattoo supply manager" }, { text: "Balloon sculptor" }, { text: "Costumed mascot" }, { text: "Tour bus driver" },
  { text: "Gondolier" }, { text: "Cultural festival organiser" }, // UK spelling
  { text: "Lighting board operator" }, { text: "Hairstylist" }, { text: "Makeup tester" },
  { text: "Chocolatier apprentice" }, { text: "Rodeo clown" }, { text: "Dog show judge" },
  { text: "Zoo educator" }, { text: "Field ecologist" }, { text: "Fishmonger" }, { text: "Comedian" },
  { text: "Digital marketer" }, { text: "Sideshow performer" }, { text: "Ballroom dance instructor" },
  { text: "Glassblower" }, { text: "Boat builder" }, { text: "Soundboard operator" }, { text: "Tattoo parlour receptionist" }, // UK spelling
  { text: "Carnival game operator" }, { text: "Ski instructor" }, { text: "Candle maker" },
  { text: "Surf instructor" }, { text: "Field archaeologist" }, { text: "Radio producer" },
  { text: "Wine taster" }, { text: "Festival organiser" }, // UK spelling
  { text: "Fantasy map artist" }, { text: "Cartography assistant" }, { text: "Vintage shop owner" },
  { text: "Acrobatics coach" }, { text: "Skateboard designer" }, { text: "Street magician" },
  { text: "Escape room host" }, { text: "Museum exhibit designer" }, { text: "Animal keeper" },
  { text: "Sex worker" }, { text: "Pimp" }, { text: "Pornstar" }, { text: "Barkeeper" },
  { text: "Beautician" }, { text: "Bee-keeper" }, { text: "Bicycle messenger" }, { text: "Bookseller" },
  { text: "Boxer" }, { text: "Bricklayer" }, { text: "Call centre agent" }, // UK spelling
  { text: "Cameraman" }, { text: "Captain" }, { text: "Cemetery gardener" }, { text: "Chancellor" },
  { text: "Chemist" }, { text: "Chimney sweep" }, { text: "Chorister" }, { text: "Circus artist" },
  { text: "Equilibrist" }, { text: "Coder" }, { text: "Comedy author" }, { text: "Computer scientist" },
  { text: "Concrete worker" }, { text: "Creative director" }, { text: "Diet counsellor" }, // UK spelling
  { text: "Doorkeeper" }, { text: "Dressmaker" }, { text: "Driving instructor" }, { text: "Educator" },
  { text: "Energy consultant" }, { text: "Estate agent" }, { text: "Goldsmith" }, { text: "Headhunter" },
  { text: "Domestic engineer" }, { text: "Human resources manager" }, { text: "Hunter" }, { text: "Interior designer" },
  { text: "Jazz musician" }, { text: "Legal expert" }, { text: "Postie" }, // UK for Mail carrier
  { text: "Market researcher" }, { text: "Marriage counsellor" }, // UK spelling
  { text: "Masseur" }, { text: "Minister of defence" }, // UK spelling
  { text: "Model" }, { text: "Mountaineer" }, { text: "Music teacher" }, { text: "Obstetrician" },
  { text: "Pathologist" }, { text: "Physician" }, { text: "Physicist" }, { text: "Piano maker" },
  { text: "Priest" }, { text: "Prompter" }, { text: "Psephologist" }, { text: "Roofer" },
  { text: "Santa" }, { text: "Shepherd" }, { text: "Shipbuilder" }, { text: "Football referee" }, // UK: replaces Soccer
  { text: "Speechwriter" }, { text: "Sports instructor" }, { text: "Stonemason" }, { text: "Stuntman" },
  { text: "Swimming pool attendant" }, { text: "Track welder" }, { text: "Train driver" },
  { text: "Violin maker" }, // UK: no hyphen
  { text: "Watchmaker" }, { text: "Filer" }, { text: "Dry cleaner" }, { text: "Lamp lighter" },
  { text: "Bathroom attendant" }, { text: "Recorder player" }, { text: "Driller" }, { text: "Sweeper" },
  { text: "Photocopier technician" }, { text: "Tree cutter" }, { text: "Roofer" }, { text: "Dictator" },
  { text: "Conductor" }, { text: "Printer" }, { text: "Grape harvester" }, { text: "Assembly line worker" },
  { text: "Ploughman" }, // UK spelling
  { text: "Preacher" }, { text: "Plasterer" }, { text: "Lecturer" },
],
Genres: [
  ...
  { text: "Traffic News" }, { text: "Docu-soap" }, { text: "Church Service / Televangelist" }, { text: "Eurovision Contest" },
  { text: "Music Chart Show" }, { text: "Infotainment" }, { text: "Antiques Advice Show" }, { text: "Open University" }, { text: "TV Shopping (Infomercial)" },
  { text: "Election Studio" }, { text: "Party Political Broadcast" }, { text: "Weather Report" }
],
...
Adjectives: [
  ...
  { text: "Optimistic" }, { text: "Pessimistic" }, { text: "Colourful" }, { text: "Pale" }, { text: "Radiant" },
  ...
  { text: "Callous" }, { text: "Ambivalent" }, { text: "Diligent" }, { text: "Obtrusive" }, { text: "Naïve" }
],
Polysemous: [
...
{ text: "Mould" }, { text: "Dock" }, { text: "Pound" }, { text: "Root" }, { text: "Table" },
